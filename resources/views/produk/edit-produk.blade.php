            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg p-6">
                <form action="{{ route('produk.update', $baju->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mt-4">
                        ...
                        <label for="apply_all_qty_checkbox" class="text-sm font-medium text-gray-700 dark:text-gray-200">Terapkan Qty pada Semua Varian</label>
                    ...
                    <div id="additional-fields" class="grid grid-cols-1 sm:grid-cols-4 gap-4 mt-8">
                        @foreach($baju->stoks as $stok)
                            <div>
                                <label for="size_{{ $stok->ukuran }}" class="block text-sm font-medium text-gray-700 dark:text-gray-200">Size ({{ $stok->ukuran }})</label>
                            ...
                            <div>
                                <label for="color_{{ $stok->warna }}" class="block text-sm font-medium text-gray-700 dark:text-gray-200">Warna</label>
                            ...
                            <div>
                                <label for="qty_{{ $stok->ukuran }}_{{ $stok->warna }}" class="block text-sm font-medium text-gray-700 dark:text-gray-200">Qty ({{ $stok->ukuran }} - {{ $stok->warna }})</label>
                            ...
                            <div>
                                <label for="harga_{{ $stok->ukuran }}_{{ $stok->warna }}" class="block text-sm font-medium text-gray-700 dark:text-gray-200">Harga ({{ $stok->ukuran }} - {{ $stok->warna }})</label>
