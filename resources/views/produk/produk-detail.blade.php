    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                <h3 class="text-xl text-center font-bold text-gray-900">Informasi Produk</h3>
                ...
                <h3 class="text-lg font-medium text-gray-900 mt-8">Stok</h3>
                <div class="mt-4">
                ...
                <h3 class="text-lg font-medium text-gray-900 mt-8">History Perubahan</h3>
                <div class="mt-4">
                    <table class="w-full text-sm text-left rtl:text-right text-gray-500">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50">
                            <tr>
